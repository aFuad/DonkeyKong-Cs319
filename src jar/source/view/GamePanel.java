...
public class GamePanel extends JPanel{
	...
	private BufferedImage bufferedImageHeart;
	private BufferedImage bufferedImageBrokenHeart;
	private Image heart;
	...
	public GamePanel(GUIPanelManager guiPanelManager) throws FileNotFoundException{
		...
		try {
			bufferedImageHeart = ImageIO.read(getClass().getResource("/image/56.png"));
			bufferedImageBrokenHeart = ImageIO.read(getClass().getResource("/image/58.png"));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		heart =  new ImageIcon(bufferedImageHeart).getImage();
		brokenHeart =  new ImageIcon(bufferedImageBrokenHeart).getImage();
