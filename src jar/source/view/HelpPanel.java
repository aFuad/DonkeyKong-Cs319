...
public class HelpPanel extends JPanel{
	...
	private JLabel returnLabel, helpLeftRight, helpUpDown, helpJump, helpSmashHammer, helpPause;
	...
	public HelpPanel(GUIPanelManager guiManager) {
		...
		try {
			label1img = ImageIO.read(getClass().getResourceAsStream("/image/a.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			label2img = ImageIO.read(getClass().getResourceAsStream("/image/b.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			label3img = ImageIO.read(getClass().getResourceAsStream("/image/c.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			label4img = ImageIO.read(getClass().getResourceAsStream("/image/d.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			label5img = ImageIO.read(getClass().getResourceAsStream("/image/e.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
