...
public class LevelSelectionPanel extends JPanel {
	...
	public LevelSelectionPanel(GUIPanelManager guiManager) {
		...
		try {
			level1img = ImageIO.read(getClass().getResourceAsStream("/image/level 1.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			level2img = ImageIO.read(getClass().getResourceAsStream("/image/level 2.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		try {
			level3img = ImageIO.read(getClass().getResourceAsStream("/image/level 3.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
